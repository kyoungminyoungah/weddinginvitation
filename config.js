...
const CONFIG = {
  ...
  accounts: {
    groom: [
      ...
      { role: "아버지", name: "이일호", bank: "우리은행", number: "1002-733-838106" },
      { role: "어머니", name: "이유정", bank: "신한은행", number: "110-469-878854" }
    ],
    bride: [
      { role: "신부", name: "김영아", bank: "카카오뱅크", number: "3333-17-4017238" },
      { role: "아버지", name: "김화식", bank: "농협은행", number: "301-0265-0954-41" },
      { role: "어머니", name: "박정순", bank: "국민은행", number: "070-21-0733591" }
    ]
  },
